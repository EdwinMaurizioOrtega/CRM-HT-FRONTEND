    ...
    return (
        <div className="card docs">
            ...
            <p>
                ...
                <Link legacyBehavior href="https://github.com/primefaces/primeicons">
                    <a className="font-medium hover:underline" target={'_blank'}>
                        PrimeIcons
                    </a>
                </Link>{' '}
                library, the official icons suite from{' '}
                <Link legacyBehavior href="https://www.primetek.com.tr">
                    <a className="font-medium hover:underline" target={'_blank'}>
                        PrimeTek
                    </a>
                </Link>
...
`}
            ...
            <p>
                ...
                <Link legacyBehavior href="https://github.com/primefaces/primeicons/issues">
                    <a className="font-medium hover:underline" target={'_blank'}>
                        request new icons
                    </a>
                </Link>{' '}
